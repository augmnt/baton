    ...
    .action(async (options) => {
      ...
      if (setupMethod === 'new') {
        ...
        if (mnemonic) {
          ...
          console.log('')
          console.log(colors.warning('  ⚠️  IMPORTANT: Write down your mnemonic phrase and store it safely!'))
        ...
        console.log('')
        console.log(colors.warning('  ⚠️  Your private key will be saved to .env'))
      ...
      // Success message
      console.log('')
      console.log(colors.success.bold('🚀 You\'re all set!\n'))
